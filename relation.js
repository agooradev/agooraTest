...
io.on('connection', function(socket){
        socket.on('chat message', function(msg){
				...
				var user = new Parse.User();
					user.save({
					username: 'peutimporte23222151',
					email: 'ladressefaual3332z2t@gmail.com',
					password: '123456'
					}, {
						success: function(response) {
							console.log(response);
							var customer = new Parse.Object('Customer');
							customer.set("name",msg);
							var relation = customer.relation("users")
							relation.add(user)
							customer.save(null,{
